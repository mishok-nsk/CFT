...
public class ConnectErrorWindow extends JDialog {
    private final List<ActionListener> reconnectListener = new ArrayList<>();
    private ActionListener exitListener;

    public ConnectErrorWindow(JFrame owner) {
        ...
        contentPane.add(createLabel(layout));
        contentPane.add(createReconnectButton(layout));
    ...
    public void addReconnectListener(ActionListener listener) {
        this.reconnectListener.add(listener);
    }
    ...
    private JButton createReconnectButton(GridBagLayout layout) {
        JButton newGameButton = new JButton("Reconnect");
        newGameButton.setPreferredSize(new Dimension(100, 25));

        newGameButton.addActionListener(e -> {
            dispose();
            for (ActionListener l : reconnectListener) {
                l.actionPerformed(e);
            }
